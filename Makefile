...
all:
	...
	gcc -m32 -I kernel/include/ -c -o kernel/init.o  kernel/init.c
	gcc -m32 -I kernel/include/ -c -o kernel/interrupt.o  kernel/interrupt.c
	ld -m elf_i386 kernel/main.o lib/kernel/print.o kernel/init.o kernel/interrupt.o kernel/kernel.o -Ttext 0xc0001500 -e main -o kernel/kernel.bin 
